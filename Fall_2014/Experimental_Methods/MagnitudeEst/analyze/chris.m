...
[h,stats.classic.p] = ttest2(inMean, outMean);
...
stats.pair.outSEM = [std(meanOut140)/sqrt(n) std(meanOut180)/ ...
                    sqrt(n)];
stats.pair.ANOVA = anova_rm({[meanIn100' meanOut140'] [meanIn140' meanOut180']},'off');
