function [dotPatchL, dotPatchR, response] = MoveTheDots2(win, params, patchNameL, patchNameR, dotPatchL, dotPatchR, duration, getResponse)
...
while keepLooping
	...
	dotPatchL = dotPatchL.move(1/frameRate);
    dotPatchR = dotPatchR.move(1/frameRate);

	
	% Update the dot positions in GLWindow.
	win.setObjectProperty(patchNameL, 'DotPositions', dotPatchL.Dots);
	win.setObjectProperty(patchNameR, 'DotPositions', dotPatchR.Dots);
