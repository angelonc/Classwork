function [win, adaptPatch, testPatchLeft, testPatchRight] = OpenEXPWindow(params)
...
testPatchLeft = DotPatch(params.test.nDots, [-200 0], params.test.rectSize, ...
	'LifeTime', params.test.lifetime, 'Velocity', params.test.dotSpeed);
testPatchRight = DotPatch(params.test.nDots, [200 0], params.test.rectSize, ...
	'LifeTime', params.test.lifetime, 'Velocity', params.test.dotSpeed);

% Add the patches to the GLWindow.
win.addDotSet(adaptPatch.Dots, params.adapt.dotRGB, params.adapt.dotSize, ...
	'Name', 'adaptPatch');
win.addDotSet(testPatchLeft.Dots, params.test.dotRGB, params.test.dotSize, ...
	'Name', 'testPatchLeft');
win.addDotSet(testPatchRight.Dots, params.test.dotRGB, params.test.dotSize, ...
	'Name', 'testPatchRight');
