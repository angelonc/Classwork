...
try	
	...
	for i = 1:params.nBlocks
		...
		for j = 1:nTests
			...
			[testPatchLeft.Coherence, testPatchLeft.Direction] = ...
				ConvertCoherence(design(index,1), params.test.HorV);
            [testPatchRight.Coherence, testPatchRight.Direction] = ...
				ConvertCoherence(design(index,1), params.test.HorV);
			...
			[testPatchLeft, testPatchRight] = MoveTheDots2(win, params, 'testPatchLeft', 'testPatchRight', testPatchLeft, testPatchRight, params.trialDuration);
